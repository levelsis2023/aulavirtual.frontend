            ...
            EstructuraOrganica: {
                ...
                permisos: [
                    ...
                    },
                    {
                        ...
                        seleccionado: false,
                        hijos: [
                            { id: 96, nombre: 'Nuevo', seleccionado: false },
                            { id: 97, nombre: 'Ver', seleccionado: false },
                            { id: 98, nombre: 'Editar', seleccionado: false },
                            { id: 99, nombre: 'Eliminar', seleccionado: false },
                        ],
                        isExpanded: false,
                    },
                    {
